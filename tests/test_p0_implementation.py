...
def test_core_agent_refactoring():
    ...
    from agentnet import AgentNet, CognitiveFault, ExampleEngine, Severity
...
def test_monitor_system_v1():
    ...
    spec = MonitorSpec(
        ...
        params={
            ...
            "violation_name": "security_violation",
        },
...
def test_session_persistence():
    ...
    from agentnet import AgentNet, ExampleEngine, SessionManager
...
def test_provider_adapters():
    ...
    from agentnet import ExampleEngine, ProviderAdapter
...
def test_integration_workflow():
    ...
    agent = AgentNet(
        "MonitoredAgent", {"logic": 0.7}, engine=engine, monitors=[monitor_fn]
    )
