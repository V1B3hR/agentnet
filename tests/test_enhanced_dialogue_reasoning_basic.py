...
def test_dialogue_mapping_basic():
    ...
    try:
        ...
        from agentnet.dialogue.mapping import DialogueMapper, EdgeType, NodeType
...
def test_integration_basic():
    ...
    try:
        ...
        # Create agent
        agent = AgentNet(
            "IntegrationTest", {"logic": 0.8, "creativity": 0.6, "analytical": 0.9}
        )
        print("  ✅ Agent created")
...
def main():
    ...
    if failed == 0:
        print(
            "🎉 All basic tests passed! Enhanced dialogue modes and reasoning types are working correctly."
        )
        return True
    else:
