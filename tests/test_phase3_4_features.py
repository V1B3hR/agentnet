...
class TestMultiModal:
    ...
    def test_modality_content(self):
        text_content = ModalityContent(
            content="Hello world", modality=ModalityType.TEXT
        )
    ...
    def test_multimodal_message(self):
        ...
        # Add image content
        message.add_image("base64data", metadata={"description": "Test image"})
...
class TestRetention:
    ...
    def test_semantic_salience_policy(self):
        ...
        entries = {"important": important_entry, "normal": normal_entry}
