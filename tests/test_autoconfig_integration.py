...
class TestAutoConfigCoreIntegration:
    ...
    def test_reasoning_tree_with_autoconfig_enabled(self):
        ...
        assert autoconfig_data["configured_max_depth"] == 3  # max(3 default, 2 autoconfig) = 3
        assert autoconfig_data["configured_confidence_threshold"] == 0.6  # auto-configured for simple task
    ...
    def test_autoconfig_reasoning_explanation(self):
        ...
        tasks = [
            ...
            ("Explain machine learning algorithms", "MEDIUM", "4 rounds", "depth 3", "confidence 0.7"),
            ("Develop comprehensive AI governance framework", "HARD", "5 rounds", "depth 4", "confidence 0.8")
        ]
        
        for task, expected_difficulty, expected_rounds, expected_depth, expected_confidence in tasks:
