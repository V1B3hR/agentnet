...
def test_api_endpoints():
    ...
    try:
        ...
        session_request = {
            ...
            "agents": [
                {"name": "Ethicist", "style": {"logic": 0.8, "creativity": 0.6, "analytical": 0.9}},
                {"name": "Technologist", "style": {"logic": 0.9, "creativity": 0.7, "analytical": 0.8}}
            ],
            "mode": "debate",
            "max_rounds": 3,
            "convergence": True,
        ...
        print(f"  ✅ Session completed: converged={result_data['converged']}, rounds={result_data['rounds_executed']}")
        ...
        print(f"  ✅ Session listing working: {len(sessions_list['sessions'])} sessions")
...
def test_api_without_server():
    ...
    request_data = {
        ...
        "agents": [
            {"name": "Engineer", "style": {"logic": 0.9, "creativity": 0.5, "analytical": 0.8}},
            {"name": "Environmentalist", "style": {"logic": 0.7, "creativity": 0.8, "analytical": 0.6}}
        ],
        "mode": "consensus",
        "max_rounds": 4,
        "convergence": True,
    ...
    async def run_test():
        ...
        print(f"  ✅ Converged: {result['converged']}, Rounds: {result['rounds_executed']}")
        return result
