...
class VectorStore(ABC):
    ...
    @abstractmethod
    def store(self, entry_id: str, vector: List[float], metadata: Dict[str, Any]) -> bool:
...
class SemanticMemory(MemoryLayer):
    ...
    def __init__(
        ...
        self.storage_path = Path(config.get("storage_path", "sessions/semantic_memory.json"))
