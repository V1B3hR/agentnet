...
class ShortTermMemory(MemoryLayer):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.truncate_strategy = config.get("truncate_strategy", "head")  # "head" or "tail"
    ...
    def get_recent_entries(self, count: int = None) -> List[MemoryEntry]:
        ...
        return list(self._entries)[-count:] if len(self._entries) > count else list(self._entries)
