                ...
                for element in array_content.split(','):
                    ...
                    if element:
                        if element.startswith('"') and element.endswith('"'):
                            ...
                            try:
                                elements.append(int(element) if '.' not in element else float(element))
                            except ValueError:
...
def parse_streaming_json(data_stream: Generator[str, None, None],
                        on_update=None) -> ParseResult:
    """
