...
class PrometheusIntegration:
    ...
    def _initialize_default_metrics(self):
        ...
        self.metrics["active_agents"] = self.Gauge(
            "agentnet_active_agents", "Number of active agents", registry=self.registry
        )
    ...
    def record_inference(
        ...
        self.metrics["agent_tokens_consumed"].labels(*labels, "output").inc(
            tokens_output
        )
    ...
    def get_alerting_rules_yaml(self) -> str:
        ...
        rules_config = {
            "groups": [{"name": "agentnet_alerts", "rules": self.alerting_rules}]
        }
...
class GrafanaIntegration:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ImportError("Grafana integration requires: pip install requests")
    ...
    def _test_connection(self):
        ...
        try:
            response = self.requests.get(
                f"{self.url}/api/health", headers=self.headers, timeout=self.timeout
            )
    ...
    def create_data_source(
        self, name: str, ds_type: str, url: str, access: str = "proxy", **config
    ) -> Dict[str, Any]:
        """
    ...
    def create_agentnet_dashboard(
        self, prometheus_datasource: str = "Prometheus"
    ) -> Dict[str, Any]:
        """
        ...
        panels = [
            ...
            # Monitor Violations Panel
            {
                ...
                "yAxes": [{"label": "Violations/sec", "min": 0}, {}],
            },
            # Active Agents Panel
            {
                "id": 6,
    ...
    def create_notification_channel(
        self, name: str, channel_type: str, settings: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        """
        channel_config = {"name": name, "type": channel_type, "settings": settings}
...
def setup_agentnet_monitoring(
    prometheus_config: Dict[str, Any], grafana_config: Dict[str, Any]
