...
try:
    ...
    class Run: pass
    class TextContentBlock: pass
    class ImageFileContentBlock: pass
...
class OpenAIAssistantsAdapter(ProviderAdapter):
    ...
    def _load_assistant(self):
        ...
        try:
            ...
            logger.info(f"Loaded assistant: {self.assistant.name} ({self.assistant.id})")
    ...
    def _create_assistant(self):
        ...
        try:
            ...
            logger.info(f"Created assistant: {self.assistant.name} ({self.assistant.id})")
        except Exception as e:
    ...
    def get_thread_messages(self, thread_id: str, limit: int = 20) -> List[ThreadMessage]:
        """
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "tools": [tool.type for tool in self.assistant.tools] if self.assistant.tools else [],
