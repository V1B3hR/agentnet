...
class EventBus:
    ...
    def remove_sink(self, sink: Any) -> None:
        ...
        if sink in self.sinks:
            ...
            logger.info(f"Removed sink {sink.__class__.__name__} from EventBus '{self.name}'")
    ...
    def enable_event_types(self, event_types: List[EventType]) -> None:
        ...
        logger.info(f"EventBus '{self.name}' enabled types: {[t.value for t in event_types]}")
    ...
    def disable_event_types(self, event_types: List[EventType]) -> None:
        ...
        logger.info(f"EventBus '{self.name}' disabled types: {[t.value for t in event_types]}")
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "enabled_types": [t.value for t in self.enabled_types] if self.enabled_types else "all",
    ...
    def clear_buffer(self) -> None:
        ...
        logger.info(f"Cleared {cleared_count} events from EventBus '{self.name}' buffer")
