...
class AttentionReasoning:
    ...
    def reason_with_attention(
        self, query: str, context: List[str], return_attention_weights: bool = False
    ) -> Dict[str, Any]:
        """
...
class GraphNeuralReasoning:
    ...
    def __init__(self, model: Optional[Any] = None, num_hops: int = 3):
        """
    ...
    def reason_over_graph(
        self, query: str, knowledge_graph: Any, max_hops: Optional[int] = None
    ) -> Dict[str, Any]:
        """
    ...
    def extract_reasoning_path(
        self, start_node: str, end_node: str, knowledge_graph: Any
    ) -> List[str]:
        """
