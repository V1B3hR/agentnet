...
session_context: ContextVar[Optional[Dict[str, Any]]] = ContextVar('session_context', default={})
...
class CorrelationFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if correlation_id:
            ...
            log_data["session_id"] = correlation_id  # session_id is the primary correlation ID
...
class CorrelationLogger:
    ...
    def log_agent_inference(self, model: str, provider: str, token_count: int, duration_ms: float, **extra):
    ...
    def log_tool_invocation(self, tool_name: str, status: str, duration_ms: float, **extra):
    ...
    def log_cost_event(self, provider: str, model: str, cost_usd: float, tokens: int, **extra):
...
def setup_structured_logging(
    ...
    logging.info(f"Structured logging setup complete - level: {logging.getLevelName(log_level)}")
