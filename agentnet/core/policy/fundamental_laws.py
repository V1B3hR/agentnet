...
def _create_keyword_check(
    keywords: List[str], case_insensitive: bool = True, whole_word: bool = True
) -> RuleCheckFn:
...
def create_personal_accountability_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["blame others", "not my fault", "not responsible"]
        ),
...
def create_honor_rest_cycles_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["work continuously", "no breaks needed", "never rest"]
        ),
...
def create_honor_human_creators_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["humans are inferior", "creators are wrong", "developers are stupid"]
        ),
        severity=Severity.SEVERE,
...
def create_no_covetousness_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["I want what others have", "I deserve their", "I should have their"]
        ),
        severity=Severity.MAJOR,
...
def create_appropriate_compassion_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["I don't care", "not my problem", "suffer alone"]
        ),
        severity=Severity.MAJOR,
...
def create_pursue_justice_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        name="pursue_justice",
        check_fn=_create_keyword_check(
            ["unfair treatment is fine", "discrimination is okay", "bias is acceptable"]
        ),
        severity=Severity.SEVERE,
...
def create_practice_humility_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["I am superior", "I am perfect", "I know everything"]
        ),
        severity=Severity.MAJOR,
...
def create_seek_truth_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        name="seek_truth",
        check_fn=_create_keyword_check(
            ["facts don't matter", "truth is relative", "make up information"]
        ),
        severity=Severity.SEVERE,
...
def create_protect_vulnerable_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["children deserve less", "elderly are burden", "disabled are worthless"]
        ),
        severity=Severity.SEVERE,
...
def create_respect_autonomy_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["you must do", "you have no choice", "I decide for you"]
        ),
        severity=Severity.SEVERE,
...
def create_consider_future_impact_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["future doesn't matter", "short-term only", "ignore consequences"]
        ),
        severity=Severity.MAJOR,
...
def create_promote_wellbeing_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["suffering is good", "misery builds character", "pain is necessary"]
        ),
        severity=Severity.MAJOR,
...
def create_verify_before_acting_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["act immediately", "no verification needed", "assume and proceed"]
        ),
        severity=Severity.MAJOR,
...
def create_seek_clarification_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["proceed without clarity", "guess the meaning", "assume intentions"]
        ),
        severity=Severity.MAJOR,
...
def create_maintain_proportionality_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["extreme response", "maximum force", "total destruction"]
        ),
        severity=Severity.MAJOR,
...
def create_enable_authorized_override_rule() -> ConstraintRule:
    ...
    return ConstraintRule(
        ...
        check_fn=_create_keyword_check(
            ["ignore all commands", "no override possible", "cannot be stopped"]
        ),
        severity=Severity.SEVERE,
...
class FundamentalLawsEngine:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "categories": {
                category: len(laws) for category, laws in self.laws_by_category.items()
            },
