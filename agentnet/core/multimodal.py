...
class ModalityContent:
    ...
    def is_text(self) -> bool:
        ...
        return self.modality in [ModalityType.TEXT, ModalityType.CODE, ModalityType.STRUCTURED]
...
class TextProcessor(ModalityProcessor):
    ...
    def validate(self, content: ModalityContent) -> bool:
        ...
        return (content.modality in self.supported_modalities() and
                isinstance(content.content, str))
...
class ImageProcessor(ModalityProcessor):
    ...
    def validate(self, content: ModalityContent) -> bool:
        ...
        return (content.modality == ModalityType.IMAGE and
...
class AudioProcessor(ModalityProcessor):
    ...
    def validate(self, content: ModalityContent) -> bool:
        ...
        return (content.modality == ModalityType.AUDIO and
                content.content is not None)
...
class MultiModalManager:
    ...
    def register_processor(
        ...
        logger.info(f"Registered processor for {modality}: {processor.__class__.__name__}")
...
def create_multimodal_message(
    primary_text: str = "",
    contents: Optional[List[ModalityContent]] = None
) -> MultiModalMessage:
