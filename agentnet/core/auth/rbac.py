...
current_user_context: contextvars.ContextVar[Optional["User"]] = contextvars.ContextVar("current_user", default=None)
current_tenant_context: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar("current_tenant", default=None)
    ...
    def _setup_default_role_permissions(self) -> Dict[Role, Set[Permission]]:
        ...
        return {
            Role.ADMIN: {
                ...
                Permission.SESSION_DELETE, Permission.SESSION_LIST,
                Permission.POLICY_CREATE, Permission.POLICY_READ, Permission.POLICY_UPDATE, Permission.POLICY_DELETE,
                Permission.COST_READ, Permission.COST_ADMIN, Permission.MONITOR_READ, Permission.MONITOR_ADMIN,
                Permission.EVAL_CREATE, Permission.EVAL_READ, Permission.EVAL_EXECUTE,
                Permission.DAG_CREATE, Permission.DAG_READ, Permission.DAG_EXECUTE,
                Permission.TOOL_CREATE, Permission.TOOL_READ, Permission.TOOL_EXECUTE,
                Permission.USER_ADMIN, Permission.TENANT_ADMIN, Permission.SYSTEM_ADMIN,
            ...
            Role.OPERATOR: {
                ...
                Permission.SESSION_CREATE, Permission.SESSION_READ, Permission.SESSION_UPDATE, Permission.SESSION_LIST,
                Permission.POLICY_READ,
                Permission.COST_READ, Permission.MONITOR_READ,
                Permission.EVAL_READ, Permission.EVAL_EXECUTE,
                Permission.DAG_READ, Permission.DAG_EXECUTE,
            ...
            Role.AUDITOR: {
                ...
                Permission.SESSION_READ, Permission.SESSION_LIST,
                Permission.POLICY_READ,
                Permission.COST_READ, Permission.MONITOR_READ,
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if tenant_check:
                ...
                if tenant_id and not rbac_manager.user_can_access_tenant(user, tenant_id):
