...
from .rbac import RBACManager, User, Role, set_current_user, set_current_tenant
...
class AuthMiddleware:
    ...
    def __init__(self, rbac_manager: RBACManager, secret_key: str = "default-secret-key"):
    ...
    def authenticate_request(self, authorization_header: Optional[str]) -> Optional[User]:
